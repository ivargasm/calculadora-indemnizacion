const Disclaimer = () => (
    <section className="mt-6 p-6 bg-red-50 rounded-lg shadow-md dark:bg-gray-800 max-w-4xl">
        <h2 className="text-lg font-semibold mb-2 text-red-600 dark:text-red-400">Importante</h2>
